...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of AVFoundationHelperRx.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/hadanischal@gmail.com/AVFoundationHelperRx'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'hadanischal@gmail.com' => 'hadanischal@gmail.com' }
  s.source           = { :git => 'https://github.com/hadanischal@gmail.com/AVFoundationHelperRx.git', :tag => s.version.to_s }
